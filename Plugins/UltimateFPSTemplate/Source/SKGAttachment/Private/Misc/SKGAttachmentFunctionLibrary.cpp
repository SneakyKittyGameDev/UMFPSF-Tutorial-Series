...
void USKGAttachmentFunctionLibrary::PrintError(const UObject* WorldObject, const FString& Error)
{
#if WITH_EDITOR
	if (WorldObject)
	{
		...
		{
			UKismetSystemLibrary::PrintString(WorldObject->GetWorld(), Error, true, true, FLinearColor::Red, 10.0f);
		}
	}
#endif
}
